...
const BARION_CALLBACK_URL = process.env.NODE_ENV === 'development' || process.env.REACT_APP_BARION_TEST_MODE === true ? "http://localhost:7235/data/ticket/ticket-status" : "https://mobiljeg.hu:7235/data/ticket/ticket-status"
const BARION_RETURN_URL = process.env.NODE_ENV === 'development' || process.env.REACT_APP_BARION_TEST_MODE === true ? "http://localhost:3000/jegyek/rendeles" : "https://mobiljeg.hu/jegyek/rendeles"
